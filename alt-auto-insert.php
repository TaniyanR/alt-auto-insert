...
final class Alt_Auto_Insert {
	...
	public static function enqueue_classic_editor_assets( $hook_suffix ) {
		...
		wp_enqueue_script(
			'alt-auto-insert-classic-editor',
			plugins_url( 'assets/classic-editor-alt.js', __FILE__ ),
			array(),
			self::VERSION,
			true
		);
	...
	public static function register_settings() {
		...
		add_settings_field( 'post_types', '対象の投稿タイプ', array( __CLASS__, 'render_post_types_field' ), 'alt-auto-insert', 'alt_auto_insert_main' );
		add_settings_field( 'content_images', '本文画像', array( __CLASS__, 'render_content_images_field' ), 'alt-auto-insert', 'alt_auto_insert_main' );
		add_settings_field( 'featured_images', 'アイキャッチ画像', array( __CLASS__, 'render_featured_images_field' ), 'alt-auto-insert', 'alt_auto_insert_main' );
	}
